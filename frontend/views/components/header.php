                        ...
                        <div class="mobile-menu-main hidden-md hidden-lg">
                            ...
                            <div id="mobile-main-nav" class="main-navigation slideLeft">
                                <div class="menu-wrapper">
                                    <div id="main-mobile-container" class="menu-content clearfix">
                                        <ul class="menu-list">
...
<div class="header-overlay-content">
    ...
    <div class="overlay overlay-hugeinc gradient-transparent overlay-menu-item">
        ...
        <nav>
            <ul class="overlay-menu"><span class="menu-click"><i class="menu-arrow fa fa-plus"></i></span>
                <li><a href="#">Home</a></li>
                <li><a href="#">About<span class="fa fa-angle-down"></span></a>
                    <ul class="sub-menu">
                        ...
                        <li><a href="#">Work</a></li>
                        <li><a href="#">Clients<span class="fa fa-angle-down"></span></a>
                            <ul class="sub-menu">
                                <li><a href="#">Home</a></li>
                                <li><a href="#">About</a></li>
                                <li><a href="#">Work</a></li>
